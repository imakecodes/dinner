  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl max-w-md w-full mx-4 text-center space-y-8 animate-in zoom-in-95 duration-300 border border-white/20 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-rose-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob"></div>
        
        <div className="relative">
            {/* Animated Icon */}
            <div className="w-24 h-24 bg-rose-600 rounded-full mx-auto flex items-center justify-center shadow-xl shadow-rose-200 mb-6 animate-bounce-slow relative">
            <i className="fas fa-hat-chef text-4xl text-white"></i>
            <div className="absolute inset-0 border-4 border-rose-400/30 rounded-full animate-ping-slow"></div>
            </div>
